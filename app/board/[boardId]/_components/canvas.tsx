...
export const Canvas = ({boardId}: CanvasProps) => {
    ...
    }, [continueDrawing,camera,canvasState,resizeSelectedLayer,translateSelectedLayers,updateSelectionNet])
    ...
    // this function select the rectangle for change the color or insterting anything
