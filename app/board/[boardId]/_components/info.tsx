...
export const Info = ({boardId}: InfoProps) => {
    ...
    return (
        <div className="absolute top-2 left-2 bg-white rounded-md p-2 h-16 flex items-center shadow-md">
            <Hint label="Go to Boards" side="bottom" sideOffset={10}>
                <Button asChild variant="board" className="px-1" onClick={() => onOpen(data._id, data.title)}>
                    <Link href={'/'}>
                        <Image
                            src="/logo.svg"
                            alt="Logo"
